...
class QuestionAnswerPromptStrategy(PromptCreationStrategy):
    ...
    def _get_default_schema_path(self) -> str:
        ...
        # Go up to the parent directory to access the main project schemas
        parent_dir = current_dir.parent
        return str(parent_dir / "prompt_xml_strategies" / "schemas" / "prompts" / "sample" / "question_answer.json")
    ...
    def get_strategy_info(self) -> Dict[str, Any]:
        ...
        """
        return {
            "name": "QuestionAnswerPromptStrategy",
            "version": "1.0.0",
