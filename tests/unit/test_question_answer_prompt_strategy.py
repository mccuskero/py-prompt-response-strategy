"""Tests for the QuestionAnswerPromptStrategy class."""
...
from prompt_xml_strategies.prompt_strategies.question_answer_prompt_strategy import QuestionAnswerPromptStrategy


class TestQuestionAnswerPromptStrategy:
    """Test cases for QuestionAnswerPromptStrategy class."""
    ...
    def test_initialization_with_custom_schema_path(self):
        ...
        strategy = QuestionAnswerPromptStrategy(schema_path=self.schema_file)
    ...
    def test_initialization_with_default_schema_path(self):
        ...
        with patch('pathlib.Path.exists', return_value=True):
            with patch('builtins.open', mock_open(read_data=json.dumps(self.schema_data))):
                strategy = QuestionAnswerPromptStrategy()
    ...
    def test_initialization_schema_file_not_found(self):
        ...
        with pytest.raises(FileNotFoundError):
            QuestionAnswerPromptStrategy(schema_path="nonexistent.json")
    ...
    def test_initialization_invalid_json(self):
        ...
        with pytest.raises(ValueError, match="Invalid JSON in schema file"):
            QuestionAnswerPromptStrategy(schema_path=invalid_schema_file)
    ...
    def test_get_strategy_info(self):
        ...
        assert info["name"] == "QuestionAnswerPromptStrategy"
