"""Tests for the QuestionAnswerResponseStrategy class."""
...
from prompt_xml_strategies.response_strategies.question_answer_response_strategy import QuestionAnswerResponseStrategy


class TestQuestionAnswerResponseStrategy:
    """Test cases for QuestionAnswerResponseStrategy class."""
    ...
    def test_initialization_with_custom_schema_path(self):
        ...
        strategy = QuestionAnswerResponseStrategy(schema_path=self.schema_file)
    ...
    def test_initialization_with_default_schema_path(self):
        ...
        with patch('pathlib.Path.exists', return_value=True):
            with patch('builtins.open', mock_open(read_data=json.dumps(self.schema_data))):
                strategy = QuestionAnswerResponseStrategy()
    ...
    def test_initialization_schema_file_not_found(self):
        ...
        with pytest.raises(FileNotFoundError):
            QuestionAnswerResponseStrategy(schema_path="nonexistent.json")
    ...
    def test_initialization_invalid_json(self):
        ...
        with pytest.raises(ValueError, match="Invalid JSON in schema file"):
            QuestionAnswerResponseStrategy(schema_path=invalid_schema_file)
    ...
    def test_process_response_with_valid_json(self):
        ...
        assert processed["_metadata"]["processed_by"] == "QuestionAnswerResponseStrategy"
    ...
    def test_get_strategy_info(self):
        ...
        assert info["name"] == "QuestionAnswerResponseStrategy"
    ...
    def test_enhance_response(self):
        ...
        assert enhanced["_metadata"]["processed_by"] == "QuestionAnswerResponseStrategy"
